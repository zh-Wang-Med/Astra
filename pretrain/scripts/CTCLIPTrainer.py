...
from data import CTReportDataset,my_CTReportDataset, my_ctrate_CTReportDataset,CTReportDataset_nlst_orianything
from data_inference_nii import CTReportDatasetinfer, my_CTReportDatasetinfer, my_ctrate_CTReportDatasetinfer
    ...
    def __init__(
        ...
        *,
        ...
        if tokenizer != None:
            ...
            self.tokenizer=BertTokenizer.from_pretrained('../hf/BiomedVLP_cxr_bert',do_lower_case=True)
        ...
        self.ds = my_ctrate_CTReportDataset(data_folder=data_train)
        # self.ds = CTReportDataset_nlst_orianything(data_folder=data_train, reports_file=reports_file_train, meta_file=train_meta_file,nlst_path=nlst_path,nlst_num=nlst_num)
        ...
        self.valid_ds = my_ctrate_CTReportDatasetinfer(data_folder=data_valid, labels = labels)
        # ipdb.set_trace()
        self.dl = DataLoader(
            self.ds,
