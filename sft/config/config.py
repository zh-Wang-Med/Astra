...
parser.add_argument('--dataset', type=str, default='rad_genome', help="iu-xray or mimic-cxr")
parser.add_argument('--annotation', type=str, default=r'../radgenome_data.json', help="annotation file of the dataset")
...
parser.add_argument('--visual_encoder_name', default="merlin", type=str)
parser.add_argument('--perceiver_whether_inital', default=True, type=lambda x: (str(x).lower() == 'true'), help='freeze vision model')
parser.add_argument('--whether_perceiver', default=False, type=lambda x: (str(x).lower() == 'true'), help="whether use lora for LLM model")
parser.add_argument('--whether_npz', default=False, type=lambda x: (str(x).lower() == 'true'), help="whether use lora for LLM model")
parser.add_argument('--perceiver_dim_head', default=64, type=int)

parser.add_argument('--perceiver_heads', default=8, type=int)
parser.add_argument('--vision_token_number', default=64, type=int)
parser.add_argument('--vision_dim', default=768, type=int)
