...
class CheXbert(nn.Module):
    def __init__(self, ckpt_dir, bert_path, checkpoint_path, device, p=0.1):
        ...
        with torch.no_grad():
            ...
            # ckpt_path = os.path.join(self.ckpt_dir, checkpoint_path)  # xiugai
            ...
            # new_state_dict["bert.embeddings.position_ids"] = torch.arange(config.max_position_embeddings).expand((1, -1))  # xiugai
